...
<?php 
require_once('connection.php'); // if u put in a sub folder: put ../connection.php
session_start(); 
if(!isset($_SESSION['User']))
    {header("location:account/login.php");} // if u put in a sub folder: put ../account/login.php
?>
